...
package com.isanechek.beardycast.ui.transition;
...
public class PlayButtonTransition extends Transition {
    ...
    public PlayButtonTransition(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PlayButtonB);
        int mode = a.getInt(R.styleable.PlayButtonB_mode, MODE_PLAY);
        a.recycle();
        mMode = mode;
    }
